...
def result():
    ...
    resultsult = a, "company is recruiting", s, "will", d, "degree with", f, "age and", g, "gender with", h, "experience and", j, "this requested salary will this person make my company better give me the answer in the HR team perspective. No more than 50 words."
    print(resultsult)
    print(a)
